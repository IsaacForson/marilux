        ...
        <Reveal y={20} delay={0.4}>
          <ul className="mt-10 flex flex-wrap gap-x-8 gap-y-3">
            {ASSURANCES.map((a) => (
              ...
              >
                <a.icon className="h-3.5 w-3.5 text-champagne" strokeWidth={1.5} aria-hidden="true" />
                {a.text}
              </li>
            ))}
          </ul>
        ...
        <div className="glass rounded-2xl px-7 py-8 text-center sm:px-10">
          ...
          <p className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 font-sans text-2xs uppercase tracking-luxe">
            <a
              ...
              className="text-champagne transition-colors hover:text-champagne-light"
            >
              WhatsApp {SITE.contact.phone}
            </a>
            <a
              href={'mailto:' + SITE.contact.email}
              className="text-ivory/45 transition-colors hover:text-champagne"
            >
              {SITE.contact.email}
            </a>
          </p>
