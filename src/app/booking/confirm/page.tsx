      ...
      <div className="shell relative mx-auto max-w-2xl text-center">
        <span
          className={
            ...
            (failed
              ? 'border-rosegold/50 bg-rosegold/10 text-rosegold-light'
              : 'border-champagne/55 bg-champagne/10 text-champagne')
          }
        >
          {failed ? (
        ...
        <p className="mt-12 text-sm text-ivory/40">
          ...
          <Link href="/contact" className="underline decoration-champagne/40 underline-offset-4">
            Contact us
          </Link>
        </p>
      </div>
