          ...
          {CHANNELS.map((c, i) => (
            <Reveal key={c.label} y={26} delay={i * 0.07}>
              <a
                ...
                className="group flex h-full flex-col rounded-[1.75rem] border border-white/[0.08] p-7 transition-all duration-700 ease-luxe hover:-translate-y-0.5 hover:border-champagne/40"
              >
                <span className="grid h-11 w-11 place-items-center rounded-full border border-champagne/25 text-champagne transition-colors duration-500 group-hover:border-champagne/60">
                  <c.icon className="h-4 w-4" aria-hidden="true" />
                </span>
                <span className="eyebrow mt-6">{c.label}</span>
                <span className="mt-2.5 break-all font-display text-xl font-light text-ivory transition-colors duration-500 group-hover:text-champagne">
                  {c.value}
                </span>
                  ...
                  {SOCIALS.map((s) => (
                    <li key={s.label}>
                      <a
                        ...
                        className="group flex items-center justify-between gap-4 border-b border-white/[0.07] pb-3 transition-colors duration-500 last:border-0 last:pb-0 hover:text-champagne"
                      >
                        <span className="flex items-center gap-3 text-sm text-ivory/60 transition-colors group-hover:text-champagne">
